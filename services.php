                ...
                <div class="row gutter-y-30">
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-duration="1500ms" data-wow-delay="00ms">
                        <div class="service-card">
                            <a href="personal-loan.php" class="service-card__image">
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-duration="1500ms" data-wow-delay="00ms">
                        <div class="service-card">
                            <a href="study-loan.php" class="service-card__image">
                                <img src="assets/images/services/2.jpg" alt="study loan">
                            </a><!-- /.service-card__image -->
                            <div class="service-card__content">
                                <h3 class="service-card__title"><a href="study-loan.php">Education Finance</a></h3><!-- /.service-card__title -->
