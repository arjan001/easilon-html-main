...
<?php include 'navbar.php'; ?>
 ...
 <!-- main navbar section ends -->
        ...
        <section class="faq-page-search section-space-bottom">
            <div class="container">
                <div class="faq-page-search__content wow fadeInUp" data-wow-duration="1500ms">
                    <h2 class="faq-page-search__title">Search Your Questions <br> Queries here</h2>
                ...
                </div><!-- /.faq-page-search__content -->
            </div><!-- /.container -->
        </section><!-- /.faq-page-search section-space-bottom -->
...
<!-- Mirrored from bracketweb.com/easilon -html-main/faq.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 04 Oct 2024 11:09:13 GMT -->
</html>